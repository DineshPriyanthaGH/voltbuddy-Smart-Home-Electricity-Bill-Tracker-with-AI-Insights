          ...
          <tbody>
            {billHistoryData.map((bill, index) => (
              <tr key={index} className="border-b border-gray-100">
                <td className="px-4 py-4 text-sm text-gray-800">{bill.period}</td>
                <td className="px-4 py-4 text-sm text-gray-800">{bill.amount}</td>
                <td className="px-4 py-4 text-sm text-gray-800">{bill.consumption}</td>
