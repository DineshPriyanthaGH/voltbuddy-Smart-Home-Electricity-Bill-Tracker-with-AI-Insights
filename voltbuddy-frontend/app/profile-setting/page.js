                ...
                {editMode && (
                  <>
                    <label
                      ...
                      className="absolute inset-0 bg-black bg-opacity-50 text-white flex items-center justify-center text-sm cursor-pointer opacity-0 group-hover:opacity-100 transition"
                    >
                      Change Photo
                    </label>
                    <input
